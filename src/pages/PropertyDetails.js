      ...
      <div className=' container mx-auto min-h-[800px] mb-14'>
        ...
        <div className=' flex flex-col items-start lg:flex-row gap-8'>
          <div className=' max-w-[768px]'>
            <div className=' rounded-tl-[90px] overflow-hidden mb-8'>
              <img className='' src={house.imageLg} alt=''/>
            </div>
          ...
          <div className=' flex-1 bg-white  w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 '>
            ...
            <form className=' flex flex-col gap-y-4'>
                <input className=' border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14'
                type='text'
                placeholder='Name:*'/>
                <input className=' border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14'
                type='text'
                ...
                <textarea className=' border border-gray-300
                 focus:border-violet-700 outline-none w-full rounded p-4 h-36 text-sm text-gray-400' placeholder='Messages' defaultValue='Hello, I am interested'></textarea>
                <div className=' flex gap-x-2'>
                  <button className=' bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition'> Send message</button>
                  <button className='border border-violet-700 text-violet-700 hover:border-violet-700 hover:text-violet-500 rounded text-sm w-full transition p-4'>Call </button>
                </div>
              </form>
          </div>
